...
const _resourceNames = [
  { value: 'cpu', label: 'CPU', labelEn: 'CPU' },
  { value: 'memory', label: '内存', labelEn: 'Memory' },
  { value: 'storage', label: '存储', labelEn: 'Storage' },
  { value: 'ephemeral-storage', label: '临时存储', labelEn: 'EphemeralStorage' },
] as const
