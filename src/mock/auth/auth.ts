import type { CurrentUserResp, LoginReq, LoginResp, CurrentMenu } from '@/types/auth/auth'
...
const kubernetesMenus: CurrentMenu[] = [
  ...
  },
  {
    ...
    name: '资源定义',
    icon: 'kubernetes-custom-resource-definition',
    type: 1,
  },
  {
...
function getCurrentUser(): CurrentUserResp {
  return {
    ...
    permissions: [
      ...
      'kubernetes:resourcequota:view',
      'kubernetes:resourcequota:create',
      'kubernetes:resourcequota:edit',
      'kubernetes:resourcequota:delete',
      'kubernetes:limitrange:view',
      'kubernetes:limitrange:create',
      'kubernetes:limitrange:edit',
      'kubernetes:limitrange:delete',
