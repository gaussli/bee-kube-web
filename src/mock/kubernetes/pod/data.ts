...
export const mockPodList: PodListVo[] = [
  ...
  },
  {
    ...
    namespaceUid: generateId(),
    namespace: 'default',
    createAt: '2025-08-28T08:15:00Z',
    createBy: 'developer',
    updateAt: '2025-08-28T08:20:00Z',
    updateBy: 'developer',
  },
  {
    uid: generateId(),
  ...
  },
  {
    ...
    namespaceUid: generateId(),
    namespace: 'bigdata',
    createAt: '2025-08-28T08:40:00Z',
    createBy: 'data-engineer',
    updateAt: '2025-08-28T08:40:00Z',
  ...
  },
  {
    ...
    namespaceUid: generateId(),
    namespace: 'default',
    createAt: '2025-08-28T08:45:00Z',
    createBy: 'developer',
    updateAt: '2025-08-28T08:45:00Z',
    updateBy: 'developer',
  },
  ...
  },
  {
    ...
    namespaceUid: generateId(),
    namespace: 'database',
    createAt: '2025-08-28T07:30:00Z',
    createBy: 'dba',
    updateAt: '2025-08-28T08:10:00Z',
    updateBy: 'system',
  },
  {
    uid: generateId(),
    ...
    namespaceUid: generateId(),
    namespace: 'storage',
    createAt: '2025-08-28T06:00:00Z',
    createBy: 'ops',
    updateAt: '2025-08-28T07:30:00Z',
    updateBy: 'system',
  },
  {
    uid: generateId(),
  ...
  },
  {
    ...
    namespaceUid: generateId(),
    namespace: 'cleanup',
    createAt: '2025-08-28T05:00:00Z',
    createBy: 'admin',
    updateAt: '2025-08-28T06:00:00Z',
    updateBy: 'system',
  },
...
export const mockPodEventList: EventListVo[] = [
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T08:05:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T08:05:00Z' },
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T08:15:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T08:15:00Z' },
    reportingController: 'kubelet',
    reportingInstance: 'kubelet-worker-01',
    action: 'Started',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T08:25:00Z',
    series: { count: 2, lastObservedTime: '2026-08-28T08:25:00Z' },
    reportingController: 'kube-scheduler',
    reportingInstance: 'scheduler-def',
    action: 'Scheduled',
    reason: 'SuccessfullyAssigned',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T08:35:00Z',
    series: { count: 3, lastObservedTime: '2026-08-28T08:35:00Z' },
    reportingController: 'kubelet',
    reportingInstance: 'kubelet-worker-07',
    action: 'FailedPull',
    reason: 'ErrImagePull',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T08:45:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T08:45:00Z' },
    reportingController: 'kubelet',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T08:50:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T08:50:00Z' },
    reportingController: 'kubelet',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T08:55:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T08:55:00Z' },
    reportingController: 'kubelet',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T09:05:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T09:05:00Z' },
    reportingController: 'kubelet',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T09:15:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T09:15:00Z' },
    reportingController: 'kubelet',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T09:25:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T09:25:00Z' },
    reportingController: 'kubelet',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T09:35:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T09:35:00Z' },
    reportingController: 'kube-scheduler',
    reportingInstance: 'scheduler-abc',
    action: 'Scheduled',
    reason: 'SuccessfullyAssigned',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T09:45:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T09:45:00Z' },
    reportingController: 'kubelet',
    reportingInstance: 'kubelet-worker-06',
    action: 'Healthy',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T09:50:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T09:50:00Z' },
    reportingController: 'kubelet',
    reportingInstance: 'kubelet-worker-07',
    action: 'Pulled',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T09:55:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T09:55:00Z' },
    reportingController: 'kubelet',
    reportingInstance: 'kubelet-worker-07',
    action: 'Started',
    reason: 'ContainerStarted',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T10:05:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T10:05:00Z' },
    reportingController: 'kubelet',
    reportingInstance: 'kubelet-worker-02',
    action: 'Started',
    reason: 'ContainerStarted',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T10:15:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T10:15:00Z' },
    reportingController: 'kubelet',
    reportingInstance: 'kubelet-worker-04',
    action: 'FailedMount',
  ...
  },
  {
    ...
    labels: { 'event-type': 'pod' },
    annotations: {},
    eventTime: '2026-08-28T10:25:00Z',
    series: { count: 1, lastObservedTime: '2026-08-28T10:25:00Z' },
    reportingController: 'kubelet',
    reportingInstance: 'kubelet-worker-04',
    action: 'Started',
    reason: 'ContainerStarted',
