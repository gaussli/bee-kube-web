<template>
  <BeePage>
    ...
    <!-- 手动触发确认 Dialog -->
    <BeeDialog
      v-model="triggerDialogConfig.visible"
      icon="kubernetes-trigger"
      :loading="triggerDialogConfig.loading"
      title="手动触发定时任务"
      type="primary"
...
import { useCronJobAction } from './composables/useAction'
import { useCronJobFetch } from './composables/useFetch'
import { useCronJobPermission } from './composables/usePermission'
import { useCronJobTable } from './composables/useTable'
...
// ==================== CronJob Composables ====================
const { permissionMap } = useCronJobPermission()
const { tableRef, loading, selectedRow, selectedRows, handleSelectionChange } = useCronJobTable()
const { queryForm, pageData, cronJobs, fetchCronJobs } = useCronJobFetch(clusterUid, loading)
const {
  searchKey,
  triggerDialogConfig,
  resumeDialogConfig,
...
} = useCronJobAction(clusterUid, permissionMap, queryForm, pageData, fetchCronJobs, tableRef, selectedRow, selectedRows)
