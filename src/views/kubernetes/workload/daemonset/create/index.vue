...
async function handleSubmit() {
  ...
  try { await createDaemonSet(formData.value); ElMessage.success('创建成功'); router.back() } catch {} finally { submitting.value = false }
}
</script>

<style lang="scss" scoped>
.daemonset-create { height: 100%; display: flex; flex-direction: column; }
