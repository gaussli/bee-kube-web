<template>
  <el-form ref="formRef" class="role-form" label-position="left" :model="formData" :rules="formRules">
    <div class="form-content">
      <el-form-item label="角色编码" prop="code">
        ...
        <el-input v-model="formData.code" :disabled="isEdit" placeholder="请输入角色编码，如 admin" />
      </el-form-item>
      ...
      <el-form-item class="form-item-full" label="描述" prop="description">
        ...
        <el-input v-model="formData.description" placeholder="请输入角色描述" :rows="3" type="textarea" />
      </el-form-item>
    </div>
  </el-form>
</template>
