...
const serviceRoutes: RouteRecordRaw[] = [
  {
    path: '/kubernetes/clusters/:clusterUid/network/service',
  ...
  {
    path: '/kubernetes/clusters/:clusterUid/network/service/create',
  ...
  {
    path: '/kubernetes/clusters/:clusterUid/network/service/edit',
  ...
  {
    path: '/kubernetes/clusters/:clusterUid/network/service/detail',
...
const ingressRoutes: RouteRecordRaw[] = [
  {
    path: '/kubernetes/clusters/:clusterUid/network/ingress',
  ...
  {
    path: '/kubernetes/clusters/:clusterUid/network/ingress/create',
  ...
  {
    path: '/kubernetes/clusters/:clusterUid/network/ingress/edit',
  ...
  {
    path: '/kubernetes/clusters/:clusterUid/network/ingress/detail',
...
const networkPolicyRoutes: RouteRecordRaw[] = [
  {
    path: '/kubernetes/clusters/:clusterUid/network/networkpolicy',
  ...
  {
    path: '/kubernetes/clusters/:clusterUid/network/networkpolicy/create',
  ...
  {
    path: '/kubernetes/clusters/:clusterUid/network/networkpolicy/edit',
  ...
  {
    path: '/kubernetes/clusters/:clusterUid/network/networkpolicy/detail',
